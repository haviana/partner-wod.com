...
class __TwigTemplate_bfc07c9db371485100b08c74b29bf944cb19ff88c7d7f051caaae6f762e28a1d extends Twig_Template
{
    ...
    ";
        ...
        if ($this->getAttribute(($context["field"] ?? null), "markdown", array())) {
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                // line 15
                echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->markdownFilter($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter($this->getAttribute(($context["field"] ?? null), "text", array())));
            } else {
                // line 17
                echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->markdownFilter($this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($this->getAttribute(($context["field"] ?? null), "text", array())));
            }
            // line 19
            echo "        </p>
    ";
...
", "forms/fields/spacer/spacer.html.twig", "/Volumes/Dados/workspace/partner-wod.com/user/plugins/form/templates/forms/fields/spacer/spacer.html.twig");
    }
}
