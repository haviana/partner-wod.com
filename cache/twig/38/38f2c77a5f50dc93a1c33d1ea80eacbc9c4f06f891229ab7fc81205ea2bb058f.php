...
class __TwigTemplate_5fe03a2f9403680ef99bfd51e89ceb5a398b930e515e2c50f6ff1a6d51b83109 extends Twig_Template
{
  ...
  <a class=\"jp-relatedposts-post-a\" href=\"";
    ...
    ";
                ...
                if (twig_first($this->env, $this->getAttribute($this->getAttribute(($context["related"] ?? null), "media", array()), "images", array()))) {
                    // line 7
                    echo "    ";
                    echo $this->getAttribute($this->getAttribute(twig_first($this->env, $this->getAttribute($this->getAttribute(($context["related"] ?? null), "media", array()), "images", array())), "cropZoom", array(0 => 241, 1 => 138), "method"), "html", array(0 => "", 1 => "", 2 => "jp-relatedposts-post-img"), "method");
                    echo "
    ";
                }
                // line 9
...
{% endif %}
{% endfor %}
", "partials/relatedpages.html.twig", "/Volumes/Dados/workspace/partner-wod.com/user/themes/gateway/templates/partials/relatedpages.html.twig");
    }
}
