...
return [
    ...
    'timestamp' => 1511344265,
    'checksum' => '5bdd8c6aa43f6538345a1bfdafdc8dcb',
    'files' => [
        'user/config' => [
            'media' => [
    ...
    'data' => [
        ...
        'site' => [
            ...
            'redirects' => [
                0 => 'Rua António Quadros nº12, Marisol'
            ],
            'routes' => NULL,
            'blog' => [
                'route' => ''
            ...
            'labels' => [
                ...
                'items' => [
                    0 => [
                        'url' => 'http://partner-wod.com/pt/tag:Alimentacao',
                        'label' => 'Alimentação'
                    ],
                    1 => [
                        'url' => 'http://partner-wod.com/pt/tag:Desporto',
                        'label' => 'Desporto'
                    ],
                    2 => [
                        'url' => 'http://partner-wod.com/pt/tag:Viagem',
                        'label' => 'Viagem'
                    ]
                ]
            ],
